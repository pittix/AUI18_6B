...
“Belt” \cite{belt} is an Body-worn controller specifically build to interact with Augmented Reality applications. As the name suggests the device is worn around the hip, like a regular belt. The device is touch-sensitive and can differentiate between simple gestures and locate the position of the touch-input \cite[p. 2136]{belt}.%([8] Page 2136).
...
% \section{Advantages and disadvantages of E-Textiles}
% Similar to the body-worn controllers described above, E-Textiles remain niche technologies despite the range of application possibilities.
...
\begin{table*}[t]
\centering
\caption{The table summarizes the different approach on testing the devices}
\label{tab:testing}
\begin{tabular}{lllll}
...
\centering
\caption{This table summarizes the different approach paper used to retrieve user feedbacks}
\label{tab:interview}
\begin{tabular}{ll}
