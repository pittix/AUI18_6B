...
%DIF ADD paper_corrected.tex   Wed Jul 18 21:29:51 2018
...
\numberofauthors{4}
\author{%
  \alignauthor{Philipp Ubrich\\
    \affaddr{T6A - AUI - TU-Dresden}\\
    \affaddr{Dresden, Germany}\\
    \email{s9706290@mail.zih.tu-dresden.de}}\\
  \alignauthor{Fabian Mischke\\
    \affaddr{T6A - AUI - TU-Dresden}\\
    \affaddr{Dresden, Germany}\\
    \email{s0189852@mail.zih.tu-dresden.de}}\\
  \alignauthor{Andrea Pittaro\\
    \affaddr{T6A - AUI - TU-Dresden}\\
    \affaddr{Dresden, Germany}\\
    \email{andrea.pittaro@studenti.unipd.it}}\\
  \alignauthor{Philip Vogel\\
    \affaddr{T6A - AUI - TU-Dresden}\\
    \affaddr{Dresden, Germany}\\
    \email{philip.vogel@mailbox.tu-dresden.de}}\\
}
...
\begin{abstract}
  ...
  To illustrate this issue, different Wearables are going to be presented - specifically concentrating on the social aspects of the devices. Finally, this paper discusses further development of social acceptability of Wearables in the future.
\end{abstract}
